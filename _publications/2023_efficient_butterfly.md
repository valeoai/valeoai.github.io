...
abstract: "Fast transforms correspond to factorizations of the form Z=X(1)…X(J), where each factor X(ℓ) is sparse and possibly structured."
---
...
<p class="pub-authors"> <a href="https://leonzheng2.github.io/">Léon Zheng</a> &nbsp;&nbsp; <a href="https://perso.ens-lyon.fr/elisa.riccietti/">Elisa Riccietti</a> &nbsp;&nbsp; <a href="https://people.irisa.fr/Remi.Gribonval/">Rémi Gribonval</a></p>
